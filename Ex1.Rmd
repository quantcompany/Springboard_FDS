...
company_names <- c("philips", "akzo", "van houten", "unilever")

for(name in company_names){
    refine$company[agrep(name, refine$company, max.distance = 0.3)] <- name
}
...
refine$product_code <- sapply(products_codes, FUN = function(x) x[1])
refine$product_number <- sapply(products_codes, FUN = function(x) x[2])
